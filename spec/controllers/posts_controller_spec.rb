...
RSpec.describe PostsController, :type => :controller do
	...
	let(:my_post) {my_topic.posts.create!(title: "Test Title", body: "Test Body")}
...
#	end
  ...
  describe "POST create" do 
	  it "increases the number of Post by 1" do
		  expect{ post :create, params: { topic_id: my_topic.id, post: { title: "Test Title", body: "Test Body"}}}.to change(Post,:count).by(1)
	  end

	  it "Assigns the new post to @post" do
		  post :create, params: { topic_id: my_topic.id, post: { title: "Test Title", body: "Test Body"}}
